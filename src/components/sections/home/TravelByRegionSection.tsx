...
export function TravelByRegionSection() {
  return (
    ...
    >
      ...
      <div className="region-blob-soft pointer-events-none absolute -bottom-16 -left-12 z-[1] h-[min(320px,50vw)] w-[min(320px,50vw)] rounded-[40%] bg-gold/25 md:-bottom-20 md:-left-16" aria-hidden />
